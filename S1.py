...
b1=t.Button(window,text="View All", width=9,command=Vcommand)
b1.grid(row=4,column=0)
b2=t.Button(window,text="Search",width=9, command=Scommand)
b2.grid(row=4,column=1)
b3=t.Button(window,text="Add", width=9, command=Acommand)
b3.grid(row=4,column=2)
b4=t.Button(window,text="Delete", width=9, command=Dcommand)
b4.grid(row=4,column=3)
b5=t.Button(window,text="Update", width=9, command=Ucommand)
b5.grid(row=4,column=4)
b6=t.Button(window,text="Close", width=9, command=window.destroy)
